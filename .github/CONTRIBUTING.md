...
```
git clone git@github.com:your-username/cordova-plugin-barqrcodescanner.git
```
...
git remote add upstream https://github.com/vikramjo/cordova-plugin-barqrcodescanner.git
```
